...
import (
	...
	dexmodule "meow/x/dex"
	dexmodulekeeper "meow/x/dex/keeper"
	dexmoduletypes "meow/x/dex/types"
	meowmodule "meow/x/meow"
	meowmodulekeeper "meow/x/meow/keeper"
	meowmoduletypes "meow/x/meow/types"
	// this line is used by starport scaffolding # stargate/app/moduleImport
)

const (
	AccountAddressPrefix = "meow"
	Name                 = "meow"
)
...
type App struct {
	*baseapp.BaseApp
	...
	MeowKeeper      meowmodulekeeper.Keeper
...
func New(
	...
	*/
	...
	app.MeowKeeper = *meowmodulekeeper.NewKeeper(
		appCodec,
		keys[meowmoduletypes.StoreKey],
		keys[meowmoduletypes.MemStoreKey],
		app.GetSubspace(meowmoduletypes.ModuleName),
	)
	meowModule := meowmodule.NewAppModule(appCodec, app.MeowKeeper, app.AccountKeeper, app.BankKeeper)
...
func initParamsKeeper(appCodec codec.BinaryCodec, legacyAmino *codec.LegacyAmino, key, tkey storetypes.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(meowmoduletypes.ModuleName)
